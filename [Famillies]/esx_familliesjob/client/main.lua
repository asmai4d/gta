...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('famillies_wear'), value = 'famillies_wear'}
  }
  ...
  ESX.UI.Menu.CloseAll()
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'famillies_wear' then
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.familliesStations[station].AuthorizedWeapons, 1 do
      local weapon = Config.familliesStations[station].AuthorizedWeapons[i]
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_familliesjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  local vehicles = Config.familliesStations[station].Vehicles
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'famillies', vehicleProps)
    ...
    for i=1, #Config.familliesStations[station].AuthorizedVehicles, 1 do
      local vehicle = Config.familliesStations[station].AuthorizedVehicles[i]
        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
			  ...
			  SetVehicleNumberPlateText(vehicle," famillies  “ .. numberplate .. ”")
			  local color = GetIsVehiclePrimaryColourCustom(vehicle)
			  SetVehicleCustomPrimaryColour(vehicle, 27, 170, 8)
            end)
...
function OpenfamilliesActionsMenu()

  ESX.UI.Menu.CloseAll()

  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'famillies_actions',
    {
      title    = 'famillies',
      align    = 'top-left',
      elements = {
        ...
        {label = '💀 Меню Банда', value = 'gang_menu1'},
        {label = '💀 Меню автомобиля', value = 'gang_menu2'},
        {label = '🐶 Меню Собака',      value = 'dog'}, 
    ...
    function(data, menu)
      ...
      if data.current.value == 'dog' then
              TriggerEvent('esx_familliesdog:openMenu')  
              menu.close()
      end
      ...
      if data.current.value == 'citizen_interaction' then
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_familliesjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_familliesjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_familliesjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_familliesjob:OutVehicle', GetPlayerServerId(player))
              end
        ...
        if data.current.value == 'gang_menu1' then 
      local elements  = {}

      local elements = {
        {label = '💀 Spawn Security (1)', value = 'spawn2'},  
        {label = '🔫 Give weapons', value = 'giveweapons2'},
        {label = '🗡️ Attack nearest player', value = 'playerattack2'},       
        {label = '🔊  Follow me', value = 'follow2'},
        {label = '🗑️ Delete', value = 'delete2'},
        {label = '------------------- Personnel -------------------', value = '--------------'},
        {label = '💉 Se mettre un bandage', value = 'small'},
      }
      
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gang_menu1', {
        css      = 'famillies',
        title    = 'Gang Menu',
        align    = 'top-left',
        elements = elements
      ...
      local elements = {
        {label = '💀 Spawn Security (1)', value = 'spawn3'},  
        {label = '🔫 Give weapons', value = 'giveweapons3'},
        {label = '🗡️ Attack nearest player', value = 'playerattack3'},       
        {label = '🔊  Follow me', value = 'follow3'},
        {label = '🗑️ Delete', value = 'delete3'},
      }
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_familliesjob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_familliesjob:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_famillies', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_familliesjob:getVehicleInfos', function(infos)
  ...
  ESX.TriggerServerCallback('esx_familliesjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_familliesjob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_familliesjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_familliesjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_familliesjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_familliesjob:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_familliesjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_familliesjob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_familliesjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if (PlayerData.job ~= nil and PlayerData.job.name == 'famillies') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'famillies') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'famillies') and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_familliesjob:hasExitedEntityZone', function(entity)
...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'famillies') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'famillies') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'famillies') then

      local playerPed = GetPlayerPed(-1)
      local coords    = GetEntityCoords(playerPed)

      for k,v in pairs(Config.familliesStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'famillies' and PlayerData.job.grade_name == 'boss' then
		...
		if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'famillies' and PlayerData.job2.grade_name == 'boss' then
		...
		if Config.EnablePlayerManagement and PlayerData.job3 ~= nil and PlayerData.job3.name == 'famillies' and PlayerData.job3.grade_name == 'boss' then
  ...
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'famillies') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'famillies') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'famillies') then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_familliesjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_familliesjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_familliesjob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_familliesjob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'famillies' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'famillies', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'famillies')
            end
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'famillies' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'famillies_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenfamilliesActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'famillies' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'famillies' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'famillies_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenfamilliesActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'famillies' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'famillies' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'famillies_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenfamilliesActionsMenu()
     GUI.Time = GetGameTimer()
    end
...
RegisterNetEvent('NB:openMenufamillies')
AddEventHandler('NB:openMenufamillies', function()
	OpenfamilliesActionsMenu()
end)
