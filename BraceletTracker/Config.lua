...
Config.AuthorizedJobsToUseTracker = {'police', 'sheriff', 'fbi', 'army'}
...
Config.ItemNames = {TrackerName = 'ankletracker', BoltCutter = 'boltcutter'}
...
Config.InformIfTargetLeavedServer = true -- Inform the Player if the target that has tracker bracelet left the server.
