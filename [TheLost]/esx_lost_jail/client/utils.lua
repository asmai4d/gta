RegisterCommand("jailmenu", function(source, args)
	...
	if PlayerData.job.name == "lost" then
		OpenJailMenu()
	else
		ESX.ShowNotification("Вы не состоите в банде The Lost!")
	end
end)
...
function Cutscene()
	...
	local Police = CreatePed(5, -1773333796, PolicePosition["x"], PolicePosition["y"], PolicePosition["z"], PolicePosition["h"], false)
