-- TriggerEvent('esx_ballasdog:openMenu') to open menu

Config = {
    Job3 = {'ballas'},
    Command = 'ballaschien', -- set to false if you dont want to have a command
    Model = 351016938,
    TpDistance = 50.0,
    Sit = {
...
Strings = {
    ['not_police'] = 'You are ~r~not ~s~ a vagos!',
    ['menu_title'] = '🐶 Vagos Dog',
