...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'famillies', Config.MaxInService)
end

-- TriggerEvent('esx_phone:registerNumber', 'famillies', _U('alert_famillies'), true, true)
...
RegisterServerEvent('esx_familliesjob:giveWeapon')
AddEventHandler('esx_familliesjob:giveWeapon', function(weapon, ammo)
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.addWeapon(weapon, ammo)
end)

RegisterServerEvent('esx_familliesjob:confiscatePlayerItem')
...
RegisterServerEvent('esx_familliesjob:getStockItem')
AddEventHandler('esx_familliesjob:getStockItem', function(itemName, count)
...
RegisterServerEvent('esx_familliesjob:putStockItems')
AddEventHandler('esx_familliesjob:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_familliesjob:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('esx_familliesjob:getFineList', function(source, cb, category)
...
ESX.RegisterServerCallback('esx_familliesjob:getVehicleInfos', function(source, cb, plate)
...
ESX.RegisterServerCallback('esx_familliesjob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_familliesjob:buy', function(source, cb, amount)
...
ESX.RegisterServerCallback('esx_familliesjob:getStockItems', function(source, cb)
...
ESX.RegisterServerCallback('esx_familliesjob:getPlayerInventory', function(source, cb)
