...
RegisterCommand("jail", function(src, args, raw)
	...
	if xPlayer["job3"]["name"] == "famillies" then
...
RegisterServerEvent("esx-qalle-jail3:jailPlayer")
AddEventHandler("esx-qalle-jail3:jailPlayer", function(targetSrc, jailTime, jailReason)
	local src = source
...
RegisterServerEvent("esx-qalle-jail3:unJailPlayer")
AddEventHandler("esx-qalle-jail3:unJailPlayer", function(targetIdentifier)
	local src = source
...
RegisterServerEvent("esx-qalle-jail3:updateJailTime")
AddEventHandler("esx-qalle-jail3:updateJailTime", function(newJailTime)
	local src = source

	EditJailTime(src, newJailTime)
end)

RegisterServerEvent("esx-qalle-jail3:prisonWorkReward")
AddEventHandler("esx-qalle-jail3:prisonWorkReward", function()
	local src = source
...
function JailPlayer(jailPlayer, jailTime)
	TriggerClientEvent("esx-qalle-jail3:jailPlayer", jailPlayer, jailTime)

	EditJailTime(jailPlayer, jailTime)
end

function UnJail(jailPlayer)
	TriggerClientEvent("esx-qalle-jail3:unJailPlayer", jailPlayer)
...
ESX.RegisterServerCallback("esx-qalle-jail3:retrieveJailedPlayers", function(source, cb)
...
ESX.RegisterServerCallback("esx-qalle-jail3:retrieveJailTime", function(source, cb)
