...
RegisterCommand("jail", function(src, args, raw)
	...
	if xPlayer["job"]["name"] == "police" or "groove" then
...
RegisterServerEvent("esx-qalle-jail2:jailPlayer")
AddEventHandler("esx-qalle-jail2:jailPlayer", function(targetSrc, jailTime, jailReason)
	local src = source
...
RegisterServerEvent("esx-qalle-jail2:unJailPlayer")
AddEventHandler("esx-qalle-jail2:unJailPlayer", function(targetIdentifier)
	local src = source
...
RegisterServerEvent("esx-qalle-jail2:updateJailTime")
AddEventHandler("esx-qalle-jail2:updateJailTime", function(newJailTime)
	local src = source

	EditJailTime(src, newJailTime)
end)

RegisterServerEvent("esx-qalle-jail2:prisonWorkReward")
AddEventHandler("esx-qalle-jail2:prisonWorkReward", function()
	local src = source
	...
	xPlayer.addInventoryItem('emballage', 1)

	TriggerClientEvent("esx:showNotification", src, "Thanks, here you have som cash for food!")
end)

function JailPlayer(jailPlayer, jailTime)
	TriggerClientEvent("esx-qalle-jail2:jailPlayer", jailPlayer, jailTime)

	EditJailTime(jailPlayer, jailTime)
end

function UnJail(jailPlayer)
	TriggerClientEvent("esx-qalle-jail2:unJailPlayer", jailPlayer)
...
ESX.RegisterServerCallback("esx-qalle-jail2:retrieveJailedPlayers", function(source, cb)
...
ESX.RegisterServerCallback("esx-qalle-jail2:retrieveJailTime", function(source, cb)
