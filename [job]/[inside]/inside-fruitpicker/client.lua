        ...
        if PlayerData.job ~= nil and PlayerData.job.grade_name == 'fruitpicker' then
            if not onDuty then
                if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 1.5) then
                        sleep = 6
                        DrawText3D(Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z + 0.4, '~g~[E]~s~ - Переодеться в рабочую одежду')
                        if IsControlJustPressed(0, Keys["E"]) then
                            if not InVehicle then
                                exports.rprogress:Custom({
                                    Duration = 2500,
                                    Label = "Ты меняешь одежду...",
                                    Animation = {
                                ...
                                exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Вы приступили к работе!", timeout = 3000})
                                onDuty = true
                                blips()
                                end)
                            else
                                exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Покинуть автомобиль!", timeout = 1500})
                            end
                        end
                    end
                end
            elseif onDuty then
                if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 1.5) then
                        sleep = 6
                        DrawText3D(Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z + 0.4, '~r~[E]~s~ - Переодеться в гражданскую одежду')
                        if IsControlJustPressed(0, Keys["E"]) then
                            if not InVehicle then
                                exports.rprogress:Custom({
                                    Duration = 2500,
                                ...
                                exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Вы закончили работу!", timeout = 3000})
                                onDuty = false
                                working = false
                                hasWashed = false
                                hasBox = false
            ...
            if onDuty then
                if (GetDistanceBetweenCoords(pos, Config.Locations["cardeposit"].coords.x, Config.Locations["cardeposit"].coords.y, Config.Locations["cardeposit"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["cardeposit"].coords.x, Config.Locations["cardeposit"].coords.y, Config.Locations["cardeposit"].coords.z, true) < 2.5) then
                        ...
                        if InVehicle then
                            sleep = 6
                            DrawText3D(Config.Locations["cardeposit"].coords.x, Config.Locations["cardeposit"].coords.y, Config.Locations["cardeposit"].coords.z + 0.4, '~r~[E]~s~ - Арендовать авто')
                            if IsControlJustReleased(0, Keys["E"]) then
                                if hasCar then
                                    DepositBack()
                                    exports.pNotify:SendNotification({text = '<b>Сборщик фруктов</b></br>Вы получили ' ..Config.DepositPrice.. '$ для возврата транспортного средства', timeout = 1500})
                                    working = false
                                    hasCar = false
                                    Plate = nil
                                    ...
                                    exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Вы не внесли залог за этот автомобиль", timeout = 1500})
                                end
                            end
                        elseif not InVehicle then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                ...
                                if hasMoney then
                                    ...
                                    exports.pNotify:SendNotification({text = '<b>Сборщик фруктов</b></br>Вы заплатили ' ..Config.DepositPrice.. '$ чтобы убрать транспортное средство', timeout = 1500})
                                    ...
                                    exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>У вас недостаточно денег", timeout = 1500})
                                end
                                end)
                            end
                        end
                            ...
                            local trunkpos = GetOffsetFromEntityInWorldCoords(vehicle, 0, -1.5, 0)
                                if not hasBox then
                                    if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, trunkpos.x, trunkpos.y, trunkpos.z, true) < 1.5 then
                                        sleep = 6
                                        DrawText3D(trunkpos.x, trunkpos.y, trunkpos.z + 0.4, "~g~[G]~s~ - Выносная корзина")
                                ...
                                elseif hasBox then
                                    ...
                                    if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, trunkpos.x, trunkpos.y, trunkpos.z, true) < 1.5 then
                                        sleep = 6
                                        DrawText3D(trunkpos.x, trunkpos.y, trunkpos.z + 0.4, "~r~[G]~s~ - Положите в корзину")
                                        if IsControlJustReleased(0, Keys["G"]) then
                                            sleep = 20
            ...
            if working then
                for i, v in ipairs(Config.OrangeSpots) do
                    if not v.taked then
                        if GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 3 then
                            sleep = 6
                            DrawText3D(v.x, v.y, v.z + 0.4, '~g~[E]~s~ - Собирать апельсины')
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                                        ...
                                        RemoveBlip(v.blip)
                                        if done == 12 then
                                            exports.pNotify:SendNotification({text = '<b>Сборщик фруктов</b></br>Вы собрали все фрукты из фруктового сада, помойте их теперь.', timeout = 5000})
                                        ...
                                        exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>У вас нет корзины", timeout = 3000})
                                    end
                                else
                                    exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Покинуть автомобиль!", timeout = 1500})
                                end
                ...
                for i, v in ipairs(Config.AppleSpots) do
                    if not v.taked then
                        if GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 3 then
                            sleep = 6
                            DrawText3D(v.x, v.y, v.z + 0.4, '~g~[E]~s~ - Собирать яблоки')
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                                        ESX.Streaming.RequestAnimDict('amb@prop_human_movie_bulb@idle_a', function()
                ...
                for i, v in ipairs(Config.StrawberrySpots) do
                    if not v.taked then
                        if GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 3 then
                            sleep = 6
                            DrawText3D(v.x, v.y, v.z + 0.4, '~g~[E]~s~ - Собирайте клубнику')
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                                        DeleteEntity(basket)
                ...
                if (GetDistanceBetweenCoords(pos, Config.Locations["transformfruit"].coords.x, Config.Locations["transformfruit"].coords.y, Config.Locations["transformfruit"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["transformfruit"].coords.x, Config.Locations["transformfruit"].coords.y, Config.Locations["transformfruit"].coords.z, true) < 2.5) then
                        sleep = 6
                        DrawText3D(Config.Locations["transformfruit"].coords.x, Config.Locations["transformfruit"].coords.y, Config.Locations["transformfruit"].coords.z + 0.4, '~g~[E]~s~ - Вымыть фрукты')
                        if IsControlJustPressed(0, Keys["E"]) then
                            if done == 12 then
                                if not InVehicle then
                                    if hasBox then
                                        if not hasWashed then
                                            ...
                                            DoScreenFadeIn(800)
                                            Citizen.Wait(800)
                                            exports.pNotify:SendNotification({text = '<b>Сборщик фруктов</b></br>Ваши фрукты готовы к продаже, отправляйтесь в магазин', timeout = 5000})
                                        ...
                                        elseif hasWashed then
                                            exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Ваши фрукты уже вымыты", timeout = 3000})
                                        end
                                    else
                                        exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>У вас нет корзины", timeout = 3000})
                                    end
                                else
                                    exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Покиньте автомобиль!", timeout = 1500})
                                end
                            else
                                exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Вы не собрали все фрукты из сада.!", timeout = 3000})
                            end
                        end
                    end
                end
                ...
                if (GetDistanceBetweenCoords(pos, Config.Locations["sellfruit"].coords.x, Config.Locations["sellfruit"].coords.y, Config.Locations["sellfruit"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["sellfruit"].coords.x, Config.Locations["sellfruit"].coords.y, Config.Locations["sellfruit"].coords.z, true) < 2.5) then
                        sleep = 6
                        DrawText3D(Config.Locations["sellfruit"].coords.x, Config.Locations["sellfruit"].coords.y, Config.Locations["sellfruit"].coords.z + 0.4, '~g~[E]~s~ - Продавать фрукты')
                        if IsControlJustPressed(0, Keys["E"]) then
                            if not InVehicle then
                                if hasBox then
                                    if hasWashed then
                                        ...
                                        exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>Вы заработали " ..Config.Payout.. "$", timeout = 3000})
                                        done = 0
                                        AmountPayout = 0
                                        hasWashed = false
                                        hasBox = false
                                        ...
                                        exports.pNotify:SendNotification({text = '<b>Сборщик фруктов</b></br>Фрукты твои не мыты!', timeout = 3000})
                                    end
                                else
                                    exports.pNotify:SendNotification({text = "<b>Сборщик фруктов</b></br>У вас нет корзины", timeout = 3000})
                                end
...
function BlipsWorking()
    for i, v in ipairs(Config.OrangeSpots) do
        ...
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentSubstringPlayerName('Апельсины Фруктовый сад')
    ...
    for i, v in ipairs(Config.AppleSpots) do
        ...
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentSubstringPlayerName('Яблоневый сад')
        EndTextCommandSetBlipName(v.blip)
    end
    ...
    for i, v in ipairs(Config.StrawberrySpots) do
        ...
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentSubstringPlayerName('Клубничный сад')
        EndTextCommandSetBlipName(v.blip)
    end
end
