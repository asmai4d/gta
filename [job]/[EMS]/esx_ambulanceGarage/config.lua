...
Config.CarDraw3DText = "[E] Чтобы открыть гараж"			-- set your desired text here
...
Config.HeliDraw3DText = "[E] PЧтобы открыть гараж"		-- set your desired text here
...
Config.BoatDraw3DText = "[E] Чтобы открыть гараж"		-- set your desired text here
...
Config.ExtraDraw3DText = "Нажмите ~g~[E]~s~ для ~y~скорой помощи~s~"		-- set your desired text here

-- ambulance Cars:
Config.ambulanceVehicles = {	
		{ model = 'ambulance', label = 'скорой помощи'},
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Возврат транспортного средства"
Config.LabelGetVeh = "Возьмите транспортное средство"
Config.LabelPrimaryCol = "Primary"
Config.LabelSecondaryCol = "Secondary"
Config.LabelExtra = "Extra"
Config.LabelLivery = "Livery"
Config.TitleambulanceGarage = "гараж скорой помощи"
...
Config.VehicleParked = "твоя машина убрана!"
Config.NoVehicleNearby = "у тебя нет машины!"
Config.CarOutFromPolGar = "Вы вытащили  ~b~автомобиль~s~ из ~y~гаража скорой помощи~s~!"
Config.HeliOutFromPolGar = "Вы вытащили ~b~Вертолет~s~ из ~y~гараж вертолета скорой помощи~s~!"
Config.BoatOutFromPolGar = "Вы вытащили ~b~Лодка~s~ из ~y~гараж для катера скорой помощи~s~!"
Config.VehRepNotify = "Ваше ~b~транспортное средство~s~ разбитым ~y~ремонтируется~s~, пожалуйста, подождите!"
Config.VehRepDoneNotify = "Ваше ~b~транспортное средство~s~ было ~y~отремонтирован~s~!"
Config.VehCleanNotify = "Ваше ~b~транспортное средство~s~ разбитым ~y~ремонтируется~s~, пожалуйста, подождите!"
Config.VehCleanDoneNotify = "Ваше ~b~транспортное средство~s~ было ~y~отремонтирован~s~!"
...
Config.VehicleLoadText = "Дождитесь появления транспортного средства"			-- text on screen when vehicle model is being loaded
