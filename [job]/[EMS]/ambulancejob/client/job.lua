...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		elements = {
			...
			{label = '<span style="color:orange;">📜Выставить счет<span style="color:white;">', value = 'billing'},
			{label = '<span style="color:green;">🚑EMS работает<span style="color:white;">', value = 'ems_ouvert'},
			{label = '<span style="color:red;">🚒EMS не работает<span style="color:white;">', value = 'ems_ferme'}
		}
	}, function(data, menu)
