...
AddEventHandler('truck_logistics:spawnTruck', function(truck_data)
	...
	local trailers = Config.empresas[empresaAtual]['trailers']
	...
	while i > 0 do
		...
		tx,ty,tz,th = table.unpack(trailers[i])
	...
	local randomTrailer = Config.trailers[math.random(1, #Config.trailers)]
	spawnTrailer(randomTrailer,tx,ty,tz,th)
