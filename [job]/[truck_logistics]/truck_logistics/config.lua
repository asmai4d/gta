...
Config.trailers = {'trailers4', 'trailers', 'trailers2', 'trailers3', 'tvtrailer'}

Config.empresas = {
	["trucker_1"] = {															-- ID
		['nome'] = "Port",														-- Name
		['coordenada'] = {1205.76,-3156.91,5.53},	-- Coordinate to open the menu
		...
		['trailers'] = {												-- Позиции спауна трейлеров
			{1250.76,-3168.05,5.86,270.00},
			{1245.91,-3135.67,5.62,270.00},
			{1246.07,-3142.42,5.63,270.00},
			{1245.93,-3149.04,5.62,270.00},
...
Config.contratos = {
	...
	['cargas'] = {
		...
		{ carga = "armytanker", nome = "Армейский топливный бак", def = {3,0,0}},
		{ carga = "armytanker", nome = "Армейское водоснабжение", def = {0,0,0}},
		{ carga = "armytanker", nome = "Армейский резервуар для Агрессивных Материалов", def = {6,0,1}},
		{ carga = "armytanker", nome = "Армейский баллон с газом", def = {2,0,0}},
		{ carga = "armytanker", nome = "Армейский баллон с токсичным газом", def = {5,0,0}},
		{ carga = "armytanker", nome = "Армейские секретные материалы", def = {0,0,1}},

		{ carga = "liquide1", nome = "Гидроксид калия", def = {6,0,0}},
		{ carga = "liquide1", nome = "Азот", def = {2,0,1}},
		{ carga = "liquide1", nome = "Хлорид калия", def = {5,0,0}},
		{ carga = "liquide1", nome = "Яд", def = {5,0,0}},
		{ carga = "liquide1", nome = "Пестициды", def = {5,0,0}},

		{ carga = "armytrailer", nome = "пустой армейский трейлер", def = {0,0,0}},

		{ carga = "armytrailer2", nome = "Перевозка тяжелой техники", def = {0,1,1}},
		{ carga = "armytrailer2", nome = "Туннельный транспорт", def = {0,1,1}},
		
		{ carga = "docktrailer", nome = "Мебель", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Рефрижераторный транспорт", def = {0,1,0}},
		{ carga = "docktrailer", nome = "Транспортировка кирпича", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Перевозка импортной продукции", def = {0,0,1}},
		{ carga = "docktrailer", nome = "Транспортировка пластика", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Перевозка одежды", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Транспортировка кресла", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Транспортировка прибора", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Перевозка чистящих средств", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Перевозка переработанной древесины", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Транспортировка камня", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Перевозка драгоценных камней", def = {0,1,1}},
		{ carga = "docktrailer", nome = "Транспортировка стекла", def = {0,1,0}},
		{ carga = "docktrailer", nome = "Транспортировка боеприпасов", def = {1,0,0}},
		
		{ carga = "freighttrailer", nome = "Трейлер пустой", def = {0,0,0}},

		{ carga = "tr2", nome = "Автомобильный прицеп пустой", def = {0,0,0}},
		
		{ carga = "trailers4", nome = "Прицеп для военно-морских изделий", def = {0,0,0}},
		{ carga = "trailers4", nome = "Прицеп для лодки", def = {0,1,1}},
		
		{ carga = "tr4", nome = "Stork", def = {0,1,1}},
		
		{ carga = "tvtrailer", nome = "Перевозка материалов для выставок", def = {0,0,1}},
		{ carga = "tvtrailer", nome = "Перевозка материалов для мероприятий", def = {0,1,1}},
		
		{ carga = "tanker", nome = "Топливный бак с присадками", def = {3,0,0}},
		{ carga = "tanker2", nome = "Топливный бак", def = {3,0,0}},
		{ carga = "tanker2", nome = "Бак для керосина", def = {3,0,0}},
		{ carga = "tanker2", nome = "Масляный бак", def = {3,0,0}},
		
		{ carga = "docktrailer", nome = "Перевозка экзотических материалов", def = {0,1,1}},
		{ carga = "docktrailer", nome = "Перевозка редких материалов", def = {0,1,1}},
		{ carga = "docktrailer", nome = "Перевозка вооружений", def = {0,0,1}},
		
		{ carga = "trailerlogs", nome = "Транспортировка бревен", def = {0,0,0}},
		
		{ carga = "trailers", nome = "Перевозка строительных материалов", def = {0,0,0}},
		{ carga = "trailers", nome = "Транспортировка резины", def = {0,0,0}},
		{ carga = "trailers", nome = "Транспортировка приборов", def = {0,1,0}},
		{ carga = "trailers", nome = "Транспортировка вакцин", def = {0,1,0}},
		{ carga = "trailers", nome = "Перевозка взрывчатых веществ", def = {1,1,0}},
		{ carga = "trailers", nome = "Транспортировка опилок", def = {0,0,0}},

		{ carga = "trailers2", nome = "Транспортировка винограда", def = {0,0,0}},
		{ carga = "trailers2", nome = "Перевозка свинины", def = {0,0,0}},
		{ carga = "trailers2", nome = "Перевозка говядины", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка моркови", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка картофеля", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка молока", def = {0,0,0}},
		{ carga = "trailers2", nome = "Перевозка консервированных продуктов", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка замороженного мяса", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка бобов", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка уксуса", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка лимонада", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка бутилированной воды", def = {0,0,0}},
		{ carga = "trailers2", nome = "Транспортировка сыра", def = {0,0,0}},

		{ carga = "trailers3", nome = "Транспортировка плитки", def = {0,0,0}},
		{ carga = "trailers3", nome = "Железнодорожный транспорт", def = {0,0,0}},
		{ carga = "trailers3", nome = "Транспортировка использованной упаковки", def = {0,0,0}},
		{ carga = "trailers3", nome = "Транспортировка плит перекрытия", def = {0,0,0}},
		{ carga = "trailers3", nome = "Керамический транспорт", def = {0,1,0}},
		{ carga = "trailers3", nome = "Транспортировка лома", def = {0,0,0}},

		{ carga = "trailers4", nome = "Перевозка фейерверков", def = {1,1,0}},
		{ carga = "trailers4", nome = "Перевозка взрывчатых веществ", def = {1,1,0}},
		{ carga = "trailers4", nome = "Транспортировка динамита", def = {1,1,0}},
		{ carga = "trailers4", nome = "Транспортировка белого фосфора", def = {4,1,0}},

		{ carga = "heli1", nome = "Вертолёт", def = {0,1,1}},
...
Config.concessionaria = {			-- Truck dealership vehicles
	...
	['packer'] = { 								-- This must be the vehicle's spawn name
		['name'] = 'packer',		-- Truck name
		['price'] = 0,						-- Value
		['engine'] = "12.0 L MB OM 457 LA I6",	-- Engine configuration
		['transmission'] = "12-Speed",			-- Transmission configuration
		['hp'] = '450',							-- Horsepower
		['img'] = 'img/packer.png',				-- Vehicle image
		['rank'] = 0
	},
...
Config.blips = {
	{1205.77,-3156.88,5.53,478,4,"Trucker Logistics",0.5 },
}