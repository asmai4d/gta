Locales['en'] = {
  ...
  ['police_wear'] = 'Полицейская форма',
  ['gilet_wear'] = 'Оранжевый жилет',
  ...
  -- Armory
  ['remove_object'] = 'Изъять объект',
  ['deposit_object'] = 'deposit object',
  ['get_weapon'] = 'Взять оружие из арсенала',
  ['put_weapon'] = 'Положить оружие в оружейной',
  ['buy_weapons'] = 'Купить оружие',
  ['armory'] = 'Арсенал',
  ['open_armory'] = 'нажмите ~INPUT_CONTEXT~, чтобы получить доступ к ~y~Арсеналу~s~.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ['armory_weapontitle'] = 'Оружейный склад - Купить оружие',
  ['armory_componenttitle'] = 'Оружейный склад - Принадлежности для оружия',
  ['armory_bought'] = 'Вы купили ~y~%s~s~ for ~r~$%s~s~',
  ['armory_money'] = 'Вы не можете позволить себе это оружие',
  ['armory_hascomponent'] = 'У вас есть это приспособление!',
  ['get_weapon_menu'] = 'Оружейный склад - Взять Оружие',
  ['put_weapon_menu'] = 'Оружейный склад - Оружие',
  -- Vehicles
  ['vehicle_menu'] = 'Транспортное средство',
  ['vehicle_blocked'] = 'Все доступные точки возрождения в настоящее время заблокированы!',
  ['garage_prompt'] = 'нажмите ~INPUT_CONTEXT~, чтобы получить доступ к ~y~ Действиям транспортного средства~s~.',
  ['garage_title'] = 'Действия транспортного средства',
