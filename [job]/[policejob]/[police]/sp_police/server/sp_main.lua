...
AddEventHandler('sp_police:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if itemType == 'item_standard' then
		...
		if targetItem.count > 0 and targetItem.count <= amount then
			...
			if sourceItem.limit ~= -1 and (sourceItem.count + amount) > sourceItem.limit then
				TriggerClientEvent('okokNotify:Alert', _source, _U('quantity_invalid'))
			else
				targetXPlayer.removeInventoryItem(itemName, amount)
				sourceXPlayer.addInventoryItem   (itemName, amount)
				TriggerClientEvent('okokNotify:Alert', _source, _U('you_confiscated', amount, sourceItem.label, targetXPlayer.name))
				TriggerClientEvent('okokNotify:Alert', target,  _U('got_confiscated', amount, sourceItem.label, sourceXPlayer.name))
			end
		else
			TriggerClientEvent('okokNotify:Alert', _source, _U('quantity_invalid'))
		end
	...
	elseif itemType == 'item_account' then
		...
		TriggerClientEvent('okokNotify:Alert', _source, _U('you_confiscated_account', amount, itemName, targetXPlayer.name))
		TriggerClientEvent('okokNotify:Alert', target,  _U('got_confiscated_account', amount, itemName, sourceXPlayer.name))
	...
	elseif itemType == 'item_weapon' then
		...
		TriggerClientEvent('okokNotify:Alert', _source, _U('you_confiscated_weapon', ESX.GetWeaponLabel(itemName), targetXPlayer.name, amount))
		TriggerClientEvent('okokNotify:Alert', target,  _U('got_confiscated_weapon', ESX.GetWeaponLabel(itemName), amount, sourceXPlayer.name))
	end
end)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police', function(inventory)
		...
		if count > 0 and inventoryItem.count >= count then
			...
			if sourceItem.limit ~= -1 and (sourceItem.count + count) > sourceItem.limit then
				...
				TriggerClientEvent('okokNotify:Alert', _source, _U('have_withdrawn', count, inventoryItem.label))
			end
		else
			TriggerClientEvent('okokNotify:Alert', _source, _U('quantity_invalid'))
		end
...
AddEventHandler('sp_police:putStockItems', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police', function(inventory)
		...
		if sourceItem.count >= count and count > 0 then
			...
			TriggerClientEvent('okokNotify:Alert', xPlayer.source, _U('have_deposited', count, inventoryItem.label))
		else
			TriggerClientEvent('okokNotify:Alert', xPlayer.source, _U('quantity_invalid'))
		end
	end)
end)
...
AddEventHandler('sp_police:message', function(target, msg)
	TriggerClientEvent('okokNotify:Alert', target, msg)
end)
