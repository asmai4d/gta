...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(462.51, -998.99, 30.6),
		},

		Armories = {
			vector3(469.68, -988.76, 20.92),	
		},

		Vehicles = {
			{
				Spawner = vector3(441.66, -989.86, 25.7),
		...
		Helicopters = {
			{
				Spawner = vector3(460.34, -980.27, 43.65),
				InsideShop = vector3(449.0, -981.4, 43.69),
				SpawnPoints = {
					{ coords = vector3(449.0, -981.4, 43.69), heading = 92.6, radius = 10.0 }
				}
			}
		},

		BossActions = {
			vector3(462.58, -985.17, 30.6),	
		}
...
Config.AuthorizedVehicles = {
	...
	recruit = {
		{ model = '211415p', label = 'Lada 2115', price = 650 }
	},

	officer = {
		{ model = 'police', label = 'Cruiser', price = 1 },
		{ model = 'police_cage', label = 'Nissan GTR Nismo', price = 1 },      
		{ model = 'polp1', label = 'McLaren P1', price = 1 }
	},
