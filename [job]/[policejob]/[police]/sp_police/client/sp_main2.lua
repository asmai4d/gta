...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {			
			...
			{label = '<span style="color:#ff0033;">🚔 Сопровождения<span style="color:cyan;"> >', value = 'securitymenu'},				
			{label = '<span style="color:#669999;">🎒 Меню Оборудования<span style="color:cyan;"> >', value = 'lspd_equipement'},
			...
			{label = '<span style="color:#050eff;">👮 Меню товарища по команде <span style="color:cyan;"> >', value = 'copmenu'},			
