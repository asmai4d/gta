...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		align    = 'top-left',
		elements = {			
			{label = '<span style="color:orange;">👮 Статус<span style="color:cyan;"> >', value = 'status'},		
			{label = '<span style="color:#006eff;">🚨 Запрос подкрепления<span style="color:cyan;"> >', value = 'renfort'},					
			{label = '<span style="color#6670501;">📣 Мегофон<span style="color:cyan;"> >', value = 'test'},				
			{label = '<span style="color:#00cc00;">🧾 Меню Гражданина <span style="color:cyan;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:#00F0FF;">💳 Лицензии<span style="color:cyan;"> >', value = 'menu_licence'},				
			{label = '<span style="color:#00cc00;">🚘 Автомобиль <span style="color:cyan;"> >', value = 'vehicle_interaction'},
            {label = '<span style="color:#ff0033;">💲 Штрафы<span style="color:cyan;"> >', value = 'ammende'},			
			{label = '<span style="color:#669999;">🔑 Наручники<span style="color:cyan;"> >', value = 'menu_menottes'},					
			{label = '<span style="color:#ff0083;">⛓ Тюрьма<span style="color:cyan;"> >', value = 'jail_menu'},			
			{label = '<span style="color:#00cc00;">🐶 Сабака<span style="color:cyan;"> >', value = 'dog'},	
			{label = '<span style="color:orange;">🎥 Камеры<span style="color:cyan;"> >', value = 'camenu'},							
			{label = '<span style="color:#669999;">🔨 Загорождения <span style="color:cyan;"> >', value = 'object_spawner'},
			{label = '<span style="color:#109999;">🔰 Щит <span style="color:cyan;"> >', value = 'boucliermenu'},				
			{label = '<span style="color:#61ff90;">🚨 Устоновить или снять Блип<span style="color:cyan;"> >', value = 'blip'},
			{label = '<span style="color:#ffc850;">📟 Радар<span style="color:cyan;"> >', value = 'rd_mobile'}			
		...
		if data.current.value == 'blip' then
            TriggerEvent("sp_PoliceEMSActivity:eblips:add")
        end
		...
		elseif data.current.value == 'menu_menottes' then
			...
			local elements = {
				{label = '<span style="color:green;">Надеть<span style="color:red;"> наручники', value = 'handcuff'},
				{label = '<span style="color:red;">Снять<span style="color:red;"> наручники', value = 'handcuff2'},
				{label = 'Сопровождения', value = 'drag'},
				{label = '<span style="color:green;">Посадить<span style="color:red;"> в машину', value = 'put_in_vehicle'},
				{label = '<span style="color:red;">Достать<span style="color:red;"> из машины', value = 'out_the_vehicle'}
			}
		...
		elseif data.current.value == 'boucliermenu' then	
			...
			local elements = {	
				{label = '🔰 Щит полиции', value = 'bouclier1'},	
				{label = '🔰 Щит Шерифа', value = 'bouc2'},	
				{label = '🔰 Щит SWAT', value = 'bouc3'},	
				{label = '🔰 Щит FBI', value = 'bouc4'},					
			}
		...
		elseif data.current.value == 'status' then
			...
			local elements = {
				{label = '<span style="color:green;">На смене<span style="color:white;">', value = 'prise'},
				{label = '<span style="color:red;">Конец смены<span style="color:white;">', value = 'fin'},
				{label = '<span style="color:orange;">Отдых<span style="color:white;">', value = 'pause'},
				
				
								
			}
			
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'Статус', {
				css      = 'police',
				title    = 'Смена',
				align    = 'top-left',
				elements = elements
		...
		elseif data.current.value == 'object_spawner' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				align    = 'top-left',
				elements = {
					{label = ('сумка'), model = 'prop_big_bag_01'},
