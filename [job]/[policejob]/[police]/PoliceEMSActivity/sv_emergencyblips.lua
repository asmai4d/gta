...
-- CONFIG --
roleList = { 
	['👮 LSPD | '] = {762310112534331442, 2, 'https://discord.com/api/webhooks/900350303612858398/WmHofdDuJzRhORHRdOUCSh5hsH6-8VhdgJSO-WyQjQbjbaZecNcvsCC6uGk62KpYBSTC'},
	['👮 Sheriff | '] = {900422330398941195, 17, nil},
	['👮 SAHP | '] = {"SAHP", 3, nil},
	['👨‍🚒 Fire/EMS | '] = {762309748233076736, 1, nil},
	['🎖️ NG | '] = {"NG", 5, nil},
}
