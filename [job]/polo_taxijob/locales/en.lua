Locales['en'] = {
  ...
  ['status'] = '<span style="color:green;">🧍‍ Agent status <span style="color:green;"> >',
  ...
  ['billing'] = '<span style="color:orange;">🧾 Billing<span style="color:orange;"> >',
  ['billing_sent'] = 'the bill has been registered!',
  ['invoice_amount'] = 'invoice amount',
  ['no_players_near'] = 'no players nearby',
  ['start_job'] = '<span style="color:red;">🚖 Start / Stop driving NPC jobs<span style="color:red;"> >',
