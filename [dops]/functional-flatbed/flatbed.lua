...
AddTextEntry(controllerMessageLoweredCar, "Нажмите ~INPUT_CONTEXT~ чтобы поднять платформу.~n~Нажмите, ~INPUT_DETONATE~ чтобы отсоединить транспортное средство.")
AddTextEntry(controllerMessageLoweredNoCar, "Нажмите ~INPUT_CONTEXT~ чтобы поднять платформу.~n~Нажмите, ~INPUT_DETONATE~ чтобы прикрепить транспортное средство.")
AddTextEntry(controllerMessageRaised, "Нажмите ~INPUT_CONTEXT~ чтобы опустить платформу.")
