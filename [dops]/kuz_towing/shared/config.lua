...
Locale.press_to_attach = 'прикрепить машину'
Locale.press_to_detach = 'отсоединить трос'
Locale.vehicles_locked = 'Этот автомобиль заблокирован и поэтому не может быть отбуксирован'
