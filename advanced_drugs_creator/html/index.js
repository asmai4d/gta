		...
		<div class="drug-effect mb-4">
			...
			<div class="effects mt-3">
				...
				<div class="row row-cols-3 mb-4">
					...
					<div class="form-check form-check-inline fs-4">
						<input class="form-check-input stackable-effect" type="checkbox" value="healthMinus80">
						<label class="form-check-label">${ getLocalizedText("menu:effects:minus_80_percent_health") }</label>
					</div>
					...
					<div class="form-check form-check-inline fs-4">
						<input class="form-check-input stackable-effect" type="checkbox" value="gain_addiction">
						<label class="form-check-label">${ getLocalizedText("menu:effects:gain_addiction") }</label>
					</div>

					<div class="form-check form-check-inline fs-4">
						<input class="form-check-input stackable-effect" type="checkbox" value="lose_addiction">
						<label class="form-check-label">${ getLocalizedText("menu:effects:lose_addiction") }</label>
					</div>
					
					<div class="form-check form-check-inline fs-4">
						<input class="form-check-input stackable-effect" type="checkbox" value="gain_stress">
						<label class="form-check-label">${ getLocalizedText("menu:effects:gain_stress") }</label>
					</div>

					<div class="form-check form-check-inline fs-4">
						<input class="form-check-input stackable-effect" type="checkbox" value="lose_stress">
						<label class="form-check-label">${ getLocalizedText("menu:effects:lose_stress") }</label>
					</div>	
