...
allEffects.healthMinus80 = function()
    local plyPed = PlayerPedId()
    local currentHealth = GetEntityHealth(plyPed)

    local newHealth = currentHealth - 80
...
allEffects.gain_addiction = function(duration)
    local effectName = "gain_addiction"
    ShowNotification("gain_addiction")
    print("gain_addiction")
end

allEffects.lose_addiction = function(duration)
    local effectName = "lose_addiction"
    print("lose_addiction")
end

allEffects.gain_stress = function(duration)
    local effectName = "gain_stress"
    print("gain_stress")
end

allEffects.lose_stress = function(duration)
    local effectName = "lose_stress"
    print("lose_stress")
end
