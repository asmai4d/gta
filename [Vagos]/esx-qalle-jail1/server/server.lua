...
RegisterCommand("jail", function(src, args, raw)
	...
	if xPlayer["job3"]["name"] == "vagos" then
...
RegisterServerEvent("esx-qalle-jail1:jailPlayer")
AddEventHandler("esx-qalle-jail1:jailPlayer", function(targetSrc, jailTime, jailReason)
	local src = source
...
RegisterServerEvent("esx-qalle-jail1:unJailPlayer")
AddEventHandler("esx-qalle-jail1:unJailPlayer", function(targetIdentifier)
	local src = source
...
RegisterServerEvent("esx-qalle-jail1:updateJailTime")
AddEventHandler("esx-qalle-jail1:updateJailTime", function(newJailTime)
	local src = source

	EditJailTime(src, newJailTime)
end)

RegisterServerEvent("esx-qalle-jail1:prisonWorkReward")
AddEventHandler("esx-qalle-jail1:prisonWorkReward", function()
	local src = source
...
function JailPlayer(jailPlayer, jailTime)
	TriggerClientEvent("esx-qalle-jail1:jailPlayer", jailPlayer, jailTime)

	EditJailTime(jailPlayer, jailTime)
end

function UnJail(jailPlayer)
	TriggerClientEvent("esx-qalle-jail1:unJailPlayer", jailPlayer)
...
ESX.RegisterServerCallback("esx-qalle-jail1:retrieveJailedPlayers", function(source, cb)
...
ESX.RegisterServerCallback("esx-qalle-jail1:retrieveJailTime", function(source, cb)
