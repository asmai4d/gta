Config = {
	...
	Text = {
		...
		['vehicleUnlocked'] = "Автомобиль был разблокирован! ~b~Водите безопасно",
		['noMoneyOrLicense'] = "У вас нет ни денег, ни действующих прав!",
		['paid'] = "Вы заплатили ~b~{price} $~w~ для вашей поездки!",
		['badParking'] = "Автомобиль был удален из-за парковки вне зоны",
		['penaltyPaid'] = "Вы заплатили ~b~{penaltyPrice} $~w~ за парковку транспортного средства вне зоны",
		['damagePenalty'] = "Вы заплатили ~b~{penaltyPrice} $~w~ за повреждение транспортного средства",
		['pricePerMinute'] = "1 Минута | ${price}",
		['vehicleInfo'] = "Транспортное средство: {info}",
		['unlockText'] = "Чтобы разблокировать, нажмите [ L ] для ${price}",
		['zoneInfo'] = "Пока вы находитесь в зоне, автомобили будут появляться!",
		['zoneTitle'] = "Зона каршеринга"
