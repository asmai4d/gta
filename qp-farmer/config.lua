...
ConfigFarmer.PlayerLoadEvent   = 'esx:playerLoaded' --event for player load, ESX = esx:playerLoaded, qbcore = QBCore:Client:OnPlayerLoaded
ConfigFarmer.MainCoreEvent     = 'esx:getSharedObject' --ESX = 'esx:getSharedObject'   qbcore = 'QBCore:GetObject'
ConfigFarmer.ItemBoxEvent = 'none' --event to show the items, ex: 'inventory:client:ItemBox' , or 'none'
ConfigFarmer.CoreResourceName  = 'es_extended'   --ESX = 'es_extended'           QBCORE = 'qb-core'
...
-- ConfigFarmer.ESXProgressBarResourceName = 'mythic_progbar'

ConfigFarmer.ReputationIdentifier = 'farmerrep' --rep name that you use in your server for restaurants reputation
ConfigFarmer.cashMoneyId = 'money' --identifier for normal money
